...
export const products = [
  {
    ...
    origin: "India",
    category: "Inciensos",
    price: 3.5, // PRECIO DE PRUEBA temporal, cambia por el real cuando quieras
    icon: "incense",
    description:
  ...
  {
    id: "atrapasuenos-arbol-pedreria",
    slug: "atrapasuenos-arbol-pedreria",
    name: "G-Atrapasueños árbol pedrería 16cm",
    origin: "India",
    category: "Complementos y Atrapasueños",
    price: null, // TODO: pon tu precio real
    icon: "dreamcatcher",
    description:
      "Atrapasueños con diseño de árbol de la vida y detalles de pedrería, 16 cm de diámetro. Varios colores disponibles.",
    stock: 18,
  },
  {
